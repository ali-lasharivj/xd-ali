...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
  ...
  const url = `https://manager-session-ben-r7g4.onrender.com/files/${sessdata}.json`;
...
*┗───━━━━───━━━━──┉┈⚆*`;
  ...
  const newsletterJids = [
    "120363333589976873@newsletter",
    "120363400497336250@newsletter"
  ];
  const emojis = ["❤️", "👍", "😯"];
